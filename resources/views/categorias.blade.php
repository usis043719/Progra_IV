                ...
                <div class="col">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">DOCENTE</h5>
                            <a href="docente" class="btn btn-primary">Ir DOCENTE</a>
                    </div>
                    </div>
                </div>
                <div class="col">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">MINISTERIO DE SALUD</h5>
                            <a href="salud " class="btn btn-primary">Ir MINISTERIO SALUD</a>
                    </div>
                    </div>
                </div>
                <div class="col">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">FAMILIA</h5>
                            <a href="familia" class="btn btn-primary">Ir FAMILIA</a>
                    </div>
                    </div>
                </div>
            </div>
